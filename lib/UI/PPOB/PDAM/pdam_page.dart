...
class PDAMPage extends StatefulWidget {
  ...
  PDAMPage(this.model, this.tabIndex);
...
class _PDAMPageState extends State<PDAMPage>
  ...
  getWilayahPDAM() async {
    ...
    //
    await widget.model.getWilayahPDAM();
    //
    EdimuLoading.tutup();
  ...
  Future getRiwayatPembayaranPLNPasca() async {
    ...
    EdimuLoading.munculkan();
    //
    await widget.model.getRiwayatListrikPascaBayar('PDAM');
    //
    EdimuLoading.tutup();
  }
  ...
  cekTagihan() async {
    ...
    infoTagihan = await widget.model
        .getTagihanListrikPascaBayar(nomorPelangganController.text, kodePasca);
    ...
    if (infoTagihan["status"] == StatusPPOB.pelangganDitemukan) {
      ...
      setState(() {
        listDetailTagihan = infoTagihan['message']["desc"]["bill"]["detail"];
      });
      ...
      Alert(
          ...
          title: "Tagihan Lunas",
          desc:
              "Selamat, Tagihan PDAM di nomor pelanggan tersebut sudah lunas.",
          buttons: [
            DialogButton(
                child: Text("OK",
                    style: TextStyle(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ListTile(
                    ...
                    trailing: Text(
                      rupiah(infoTagihan["message"]["admin"]),
                      style: TextStyle(
                          fontSize: 19,
                          color: Colors.black,
                            ...
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  child: Center(
                                      child: Text(
                                          "Tagihan ${hitungBulanListrikPPOB(listDetailTagihan[index]['period'])}",
                                          style: TextStyle(
            ...
            onPressed: () async {
              ...
              if (res[0] == StatusPPOB.sukses) {
                ...
                Alert(
                    ...
                    title: "Sukses",
                    type: AlertType.success,
                    desc: "pembayaran tagihan PDAM anda berhasil!",
                    buttons: [
                      DialogButton(
                          color: Colors.blue[800],
                          child: Text(
                          ...
                          onPressed: () {
                            ...
                            Navigator.push(context,
                              ...
                              return PDAMPage(widget.model, 0);
                            }));
                            // tabController.animateTo(1);
                          })
                    ]).show();
