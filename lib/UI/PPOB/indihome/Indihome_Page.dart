...
class IndihomePage extends StatefulWidget {
  MainModel model;
  int tabIndex;
  // IndihomePage(this.model);

  IndihomePage(this.model, this.tabIndex);

  @override
  _IndihomePageState createState() => _IndihomePageState();
}
...
class _IndihomePageState extends State<IndihomePage>
  ...
  void initState() {
    ...
    getRiwayatPembayaranIndihomePasca();
    super.initState();
  ...
  Future getRiwayatPembayaranIndihomePasca() async {
    EasyLoading.show(
    ...
    //
    await widget.model.getRiwayatListrikPascaBayar('TELKOM');
    //
    EasyLoading.dismiss();
  }
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  height: 70,
                  child: Image.asset(
                    "lib/assets/PPOB/logo_Indihome.png",
                    width: 70,
                  ),
                ),
                SizedBox(
  ...
  cekTagihan() async {
    ...
    infoTagihan = await widget.model.getTagihanListrikPascaBayar(
        nomorPelangganController.text, "TELKOMPSTN");
    ...
    if (infoTagihan["status"] == StatusPPOB.pelangganDitemukan) {
      ...
      Alert(
          ...
          title: "Tagihan Lunas",
          desc:
              "Selamat, Tagihan Indihome di nomor pelanggan tersebut sudah lunas.",
          buttons: [
            DialogButton(
                child: Text("OK",
                    style: TextStyle(
                            ...
                            child: Column(
                              children: [
                                Container(
                                  ...
                                  child: Center(
                                      child: Text(
                                          "Tagihan ${bulanPembayaranIndihome(listDetailTagihan[index]['periode'])}",
                                          style: TextStyle(
...
bulanPembayaranIndihome(String angka) {
  String angkaBulan = angka.substring(0, 3);
  String angkaTahun = angka.substring(4);
  ...
  finalString = "${getNamaBulan(angkaBulan)} $angkaTahun";
            ...
            onPressed: () async {
              ...
              if (res[0] == StatusPPOB.sukses) {
                ...
                Alert(
                    ...
                    title: "Sukses",
                    type: AlertType.success,
                    desc: "pembayaran tagihan Indihome anda berhasil!",
                    buttons: [
                      DialogButton(
                          color: Colors.blue[800],
                          child: Text(
                          ...
                          onPressed: () {
                            ...
                            Navigator.push(context,
                              ...
                              return IndihomePage(widget.model, 0);
                            }));
                            // tabController.animateTo(1);
                          })
                    ]).show();
